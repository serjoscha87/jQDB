...
class ConnectorSelector {
    ...
    * @return iConnector the concrete connector class object (if found, return the desired connector; otherwise return the first existing one)
    */
   public function getConector($connector) {
      return $this->connectors[$connector] ? $this->connectors[$connector] : $this->connectors[array_keys($this->connectors)[0]];
   }
